  ...
  <div class="layui-side-scroll layui-left-menu">
    <ul class="layui-nav layui-nav-tree layui-left-nav-tree layui-this" id="currency">
      ...
      <li class="layui-nav-item">
        <a href="index.jsp" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-3">
      ...
      <li class="layui-nav-item layui-nav-itemed">
        ...
        <dl class="layui-nav-child">
          <dd>
            <a href="listAllOrders.action" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-8">
      ...
      <span class="layui-nav-bar" style="top: 0px; height: 0px; opacity: 0;"></span>
    </ul>
  </div>
</div>
