    ...
    <form class="layui-form layuimini-form" action="" method="post" style="margin-left:-30px;padding-right:50px">
      <div class="layui-form-item">
        ...
        <div class="layui-input-block">
          <input type="text" name="room.phone" value="201" class="layui-input" readonly>
        </div>
      </div>
      <div class="layui-form-item">
        <label class="layui-form-label">房间类型:</label>
        <div class="layui-input-block">
          <input type="text" name="room.roomType" value="王凌云"
      ...
      <div class="layui-form-item">
        ...
        <div class="layui-input-block">
          <input type="text" name="room.roomDetail" value="楼下施工"
